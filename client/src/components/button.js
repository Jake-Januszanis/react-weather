...
function Button () {
    ...
    return(
        ...
        <input className="inline w-2/3 h-8 block pl-2 ml-8 border-2 border-gray-50  sm:text-sm border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:border-blue-100 max-w-lg" type='number' name='zipcode' placeholder="Enter new zipcode..." required></input>
