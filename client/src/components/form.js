    ...
    return(
        <div>
            <form className="h-auto flex flex-col justify-center items-center" method="POST" action="server.js">
                <label className="text-4xl mb-6 text-gray-500">Enter 5 digit zipcode</label>
                ...
                <button className="max-w-xs w-3/12 h-auto mb-8 text-white text-sm md:text-xl shadow-md rounded-2xl bg-blue-500 hover:bg-blue-700"  type="submit">Check Weather</button>
            </form>
